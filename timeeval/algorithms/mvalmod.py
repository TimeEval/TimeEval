...
_mvalmod_parameters: Dict[str, Dict[str, Any]] = {
 "exclusion_zone": {
  "defaultValue": 0.5,
...
def mvalmod(params: Optional[ParameterConfig] = None, skip_pull: bool = False, timeout: Optional[Duration] = None) -> Algorithm:
    return Algorithm(
        name="mVALMOD",
        main=DockerAdapter(
        ...
        param_schema=_mvalmod_parameters,
