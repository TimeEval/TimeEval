...
dads = DistributedAdapter(dads, "java -jar /home/phillip.wenig/Projects/DADS/target/distributed-anomaly-detection.jar slave --host odin01 --master-host odin01 --no-statistics", "phillip.wenig", remote_hosts=[r.get("host") for r in remotes])
