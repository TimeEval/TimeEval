...
def main():
    ...
    datasets += dm.select(collection_name="KDD-TSAD", dataset_name="239_UCR_Anomaly_taichidbS0715Master")
    datasets += dm.select(collection_name="KDD-TSAD", dataset_name="240_UCR_Anomaly_taichidbS0715Master")
    datasets += dm.select(collection_name="Exathlon", dataset_name="4_1_100000_61-29")
