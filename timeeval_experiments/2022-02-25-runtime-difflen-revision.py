...
from timeeval import TimeEval, Datasets, TrainingType, DatasetManager
...
def main():
    dm = DatasetManager(HPI_CLUSTER.akita_test_case_variable_length_path, create_if_missing=False)
