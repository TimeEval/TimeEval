...
def stamp(params=None, skip_pull: bool = SKIP_PULL, timeout: Duration = DEFAULT_TIMEOUT) -> Algorithm:
    return Algorithm(
        name="STAMP-docker",
        main=DockerAdapter(image_name="mut:5000/akita/stamp", skip_pull=skip_pull, timeout=timeout),
